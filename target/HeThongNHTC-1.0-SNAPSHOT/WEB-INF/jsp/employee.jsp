...
<br/>
<form class="d-flex">
    <input class="form-control me-2" name="un" type="text" placeholder="Mã nhân viên, username"/>
        ...
        <c:forEach items="${employee}" var="e">
            <tr>
                ...
                <td>
                        ...
                        <a type="button" href="/HeThongNHTC/admin/updateEmployee/${e[0]}" class="btn btn-danger" >Cap nhat</a>
                    </td>
                <td>
                    <input type="button" 
                           value="Xoa" 
                           onclick="deleteEmployee(${e[0]})"
