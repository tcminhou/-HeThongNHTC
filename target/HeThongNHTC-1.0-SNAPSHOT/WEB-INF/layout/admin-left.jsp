...
<nav class="navbar bg-light">
  <div class="container-fluid">
    <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="<c:url value="/admin/lobby" />">Quản lý nhà hàng</a>
      </li>
<!--      <li class="nav-item">
          <a class="nav-link" href="<c:url value="/admin/menu" />">Quản lý menu</a>
      </li>-->
      <li class="nav-item">
          <a class="nav-link" href="<c:url value="/admin/service" />">Quản lý chủ nhà hàng</a>
      </li>
      <li class="nav-item">
...
<!--      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<c:url value="/admin/revenue" />">Đăng xuất</a>
      </li>
