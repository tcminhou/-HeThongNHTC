...
public class ServiceRepositoryImpl implements ServiceRepository {
    ...
    @Override
    public List<Service> getServices(Map<String, String> params, int page, int id) {
...
//        }
    ...
    public int countService(int id) {
        Session session = this.sessionFactory.getObject().getCurrentSession();
        Query q = session.createQuery("select Count(l.id) FROM Service l Where l.idRestaurant = "+ id);
